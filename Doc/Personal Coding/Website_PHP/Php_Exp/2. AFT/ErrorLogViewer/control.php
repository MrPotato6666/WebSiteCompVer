...
?>
<html>
<body bgcolor=black leftmargin="0" topmargin="0" text=yellow link=yellow vlink=rgb(68,85,90) alink=yellow>
<FIELDSET>
...
for ($i=1;$i<=$total_line_num;$i++)
{
	echo "<li><a href='index.php?file=$file&line=$i&errorcode=-1&stat=0&mode=0' target=_top><font face='arial'>Line ".$i." Process Mode</font></a><br>";
	echo "<li><a href='index.php?file=$file&line=$i&errorcode=-1&stat=0&mode=1' target=_top><font face='arial'>Line ".$i." Standby Mode</font></a><br>";
	echo "<li><a href='index.php?file=$file&line=$i&errorcode=-1&stat=0&mode=2' target=_top><font face='arial'>Line ".$i." Idle Mode</font></a><br>";
}
?>
</FIELDSET>
<?
